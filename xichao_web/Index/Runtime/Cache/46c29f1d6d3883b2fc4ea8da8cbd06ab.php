...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/special_proj.css">
...
<!--###################################special##################################-->
            <div id = "special_proj">
                <h1 id="header">特别项目</h1>
                <div id="brief-intro">
                根据视觉识别系统，按照企业的核心理念，进行用户研究，定义视觉设计的新趋势，完成相关日用品的平面设计、空间设计和网站设计和制作。
                </div>
<!--###################################form###################################--> 
                <div>
