...
def mobile_article(tid):
    ...
    #print category
    signature=wechat_signature('http://xichao-o.com/mobile/article/'+str(tid)+'/?from=singlemessage&isappinstalled=0','wxf1186930550941c5','84bfbb6d5841fba82cb50cecf4f9721b','xichao','1414587457')
